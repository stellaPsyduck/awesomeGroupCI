...
The data was scaled logarithmically. This was to ensure stability in our predictions by reducing 
the effect of outliers on the model and to account for the exponential patterns in each of the stock data.
...
The scaling affect is shown in \ref{appendix_a}, the medium stock ACIW is on a similar scale to the large 
